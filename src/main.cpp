...
const char *wifi_ssid = "iPhone de Kamila";
const char *wifi_password = "Kamila2001";
...
const char *client_id = "TD04_GP09";
...
void setup()
{
  ...
  else
  {
   ...
   {
    mqtt_client.publish("TD04_GP09/temp",String(temp_measure).c_str());
    mqtt_client.publish("TD04_GP09/relhum",String(relative_humidity_measure).c_str());
   }
